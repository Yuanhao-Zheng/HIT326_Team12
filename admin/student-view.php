                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button onClick="javascript: return confirm('Are you sure you want to delete');" href="submit" name="student_delete" value="<?= $item['student_id'] ?>" class="btn btn-danger">Delete</button>
                                            </form>
